...
const links = [
	...
	},
	{
		...
		icon: (
			...
			>
				<path
					d='M7.5 0C3.36 0 0 3.36 0 7.5S3.36 15 7.5 15 15 11.64 15 7.5 11.64 0 7.5 0zm0 1c3.59 0 6.5 2.91 6.5 6.5S11.09 14 7.5 14 1 11.09 1 7.5 3.91 1 7.5 1zm0 2a4.5 4.5 0 100 9 4.5 4.5 0 000-9zm0 1a3.5 3.5 0 110 7 3.5 3.5 0 010-7z'
					fill='currentColor'
				/>
			</svg>
		),
